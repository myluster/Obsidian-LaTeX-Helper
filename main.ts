...
// 3. The main class of the plugin, extending Obsidian's Plugin class.
export default class MyPlugin extends Plugin {
	...
	async onload() {
		...
		this.registerView(
			...
			(leaf) => new MyView(leaf, this) // 将插件实例 (this) 传递给视图，以便视图能访问设置
		);
...
// 4. 设置页面的类定义
// 4. The class definition for the settings tab.
